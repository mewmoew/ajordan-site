...
export function MaintenanceScreen() {
  ...
  return (
    <div style={{
      ...
      {/* CTA button — shown before form opens */}
      {!showForm && !done && (
        <button
          ...
          style={{
            ...
            border: "1px solid rgba(192,38,211,0.65)",
            color: "#e879f9",
            fontFamily: "var(--font-vt323), monospace",
            fontSize: "1.15rem", letterSpacing: "0.24em",
            cursor: "pointer",
            textShadow: "0 0 10px rgba(192,38,211,0.5)",
            boxShadow: "0 0 22px rgba(192,38,211,0.15), inset 0 0 18px rgba(192,38,211,0.04)",
            transition: "all 0.2s",
          }}
        ...
        <div className="ms-expand" style={{ position: "relative", width: "100%", maxWidth: "380px", background: "rgba(8,0,18,0.92)", border: "1px solid rgba(192,38,211,0.45)", boxShadow: "0 0 40px rgba(192,38,211,0.12), inset 0 0 30px rgba(0,0,0,0.3)", padding: "clamp(20px, 4vw, 28px)", textAlign: "left" }}>
          ...
          {done ? (
            <div style={{ textAlign: "center", padding: "8px 0 4px" }}>
              ...
              <div style={{ color: "#c8b8e0", fontSize: "0.88rem", lineHeight: 1.6 }}>
                {successLine}
              </div>
              {promoLine && (
              ...
              <form onSubmit={handleSignup} style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                ...
                <div>
                  ...
                  <div style={{ position: "relative" }}>
                    <input
                      ...
                      placeholder="ENTER CODE" maxLength={32} autoComplete="off"
                    />
                  ...
                  {promoState === "valid" && promoBonus && (
                    <div style={{ marginTop: "4px", fontSize: "0.68rem", color: "#00e5ff", letterSpacing: "0.1em" }}>+{promoBonus.xpBonus} XP — {promoBonus.description}</div>
                  )}
                  {promoState === "invalid" && (
                    <div style={{ marginTop: "4px", fontSize: "0.68rem", color: "#884444", letterSpacing: "0.08em" }}>code not recognized</div>
                  )}
                </div>

                {error && (
                  <div style={{ fontSize: "0.75rem", color: "#ff5555", letterSpacing: "0.1em", textAlign: "center" }}>✗ {error}</div>
                )}
                ...
                <button
                  ...
                  style={{
                    ...
                    textShadow: "0 0 10px rgba(192,38,211,0.5)", transition: "all 0.18s",
                  }}
                >
